...
<div class="row page-titles">
	<div class="col-md-5 align-self-center">
		 <h4 class="text-themecolor">{{ trans('global.UserManage.edit') }}</h4>
	</div>
	<div class="col-md-7 align-self-center text-right">
		 <div class="d-flex justify-content-end align-items-center">
			  <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">{{ trans('global.UserManage.edit') }}</li>
			  </ol>
		 </div>
	</div>
</div>
					...
					<form class="form" action="{{ route('admin.users.update', $user->guid) }}" method="POST">
						...
						<div class="form-group m-t-40 row">
							...
							<div class="col-md-10 col-sm-12">
								<input name="reference" class="form-control @error('reference') is-invalid @enderror" value="{{ $user->reference }}" placeholder="{{ trans('global.Reference') }}">
						...
						<div class="form-group row">
							...
							<div class="col-md-10 col-sm-12">
								<input name="name" class="form-control @error('name') is-invalid @enderror" value="{{ $user->name }}" required placeholder="{{ trans('global.Name') }}">
								@if($errors->has('name'))
								<span class="invalid-feedback" role="alert">
						...
						<div class="form-group row">
							...
							<div class="col-md-10 col-sm-12">
								<input name="email" class="form-control @error('email') is-invalid @enderror" type="email" value="{{ $user->email }}" required placeholder="{{ trans('global.Email') }}">
								@if($errors->has('email'))
								<span class="invalid-feedback" role="alert">
						...
						<div class="form-group row">
							...
							<div class="col-md-10 col-sm-12">
								<div class="row mr-0 ml-0">
									...
									<input name="cellphone" class="form-control @error('cellphone') is-invalid @enderror offset-1 col-md-6 col-sm-12" value="{{ $user->cellphone }}" required placeholder="{{ trans('global.Cellphone') }}">
								</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-10 col-sm-12">
								<input name="password" class="form-control @error('password') is-invalid @enderror" type="password" placeholder="{{ trans('global.Password') }}">
